...
namespace adolli
{
    public class FaceU : SmallCubeGroup
    {

        public FaceU(RubicCube cube) : base(cube, new Vector3(0, 1f, 0))
        {
        }
        ...
        public override void Bind()
        {
            ...
            // 旋转触摸面
            cube_.rotationControlPanes_[0].transform.parent = cube_.cubeCenter_.transform;
        }
        ...
        public override void Unbind()
        {
            ...
            cube_.rotationControlPanes_[0].transform.parent = cube_.rotationControlRoot_.transform;
