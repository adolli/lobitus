...
namespace adolli
{
    public class FaceF : SmallCubeGroup
    {

        public FaceF(RubicCube cube) : base(cube, new Vector3(1f, 0, 0))
        {
        }
        ...
        public override void Bind()
        {
            ...
            cube_.rotationControlPanes_[3].transform.parent = cube_.cubeCenter_.transform;
        }
        ...
        public override void Unbind()
        {
            ...
            cube_.rotationControlPanes_[3].transform.parent = cube_.rotationControlRoot_.transform;
