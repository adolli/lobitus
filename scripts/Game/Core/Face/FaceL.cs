...
namespace adolli
{
    public class FaceL : SmallCubeGroup
    {

        public FaceL(RubicCube cube) : base(cube, new Vector3(0, 0, -1f))
        {
        }
        ...
        public override void Bind()
        {
            ...
            cube_.rotationControlPanes_[2].transform.parent = cube_.cubeCenter_.transform;
        }
        ...
        public override void Unbind()
        {
            ...
            cube_.rotationControlPanes_[2].transform.parent = cube_.rotationControlRoot_.transform;
